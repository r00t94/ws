...
elseif UserID == 996310583 or UserID == 1399282735 or UserID == 1399227146 or UserID == 1790645201 or UserID == 1666331916 or UserID == 1188408162 then  
...
if UserID == 996310583 or UserID == 1399282735 or UserID == 1399227146 or UserID == 1790645201 or UserID == 1666331916 or UserID == 1188408162 then return sendMsg(msg.chat_id_,msg.id_,"⌯  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
return '⌯ اصدار سورس ويـزَرد*v'..version..'* \n'
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(ws..":awamer_Klesha_m4:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
print("Update Source And Reload ~ ./salem/Run.lua And change username sudo")
