...
redis:setex(ws.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
...
if not redis:get(ws..'lock_geams'..msg.chat_id_) and msg.GroupActive then
...
redis:set(ws.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
...
redis:set(ws..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_Hzorh:'..msg.chat_id_,name)
...
Num = math.random(1,6)
redis:set(ws.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(ws.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
return '◀️┇اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️┇اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
end
end

if MsgText[1] == 'ترتيب' then
if not Arry_Word or not redis:get(ws..":GetInfoNow:") then
local Trteb_Word , res = https.request('https://api.th3ws.com/Words.json')
...
redis:setex(ws..":GetInfoNow:",7200,true)
end
local Text , UnText = next(Arry_Word.AllWords[math.random(#Arry_Word.AllWords)])
print(Text)
redis:set(ws..':Set_Arg:'..msg.chat_id_,Text)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_Name_Meant:'..msg.chat_id_,name)
...
redis:set(ws.."GAME:CHER"..msg.chat_id_,'فهمت') 
elseif SENDTEXT:find('مو جبان') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'نشط') 
elseif SENDTEXT:find('مو زين') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو زين') 
elseif SENDTEXT:find('مو عطشان') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو عطشان') 
elseif SENDTEXT:find('حاره') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'حاره') 
elseif SENDTEXT:find('مو خايف') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو خايف') 
elseif SENDTEXT:find('خلف') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'خلف') 
elseif SENDTEXT:find('وفي') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'وفي') 
elseif SENDTEXT:find('قزم') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'قزم') 
elseif SENDTEXT:find('لين') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'لين') 
elseif SENDTEXT:find('خشن') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'خشن') 
elseif SENDTEXT:find('عاقل') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'عاقل') 
elseif SENDTEXT:find('ذكي') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'ذكي') 
elseif SENDTEXT:find('مو ظلمه') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو ظلمه') 
elseif SENDTEXT:find('مو مسموح') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
elseif SENDTEXT:find('اسمعك') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'اسمعك') 
elseif SENDTEXT:find('روح') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'روح') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:incrby(ws..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "⌯ تم خصم {* "..MsgText[2].." *} من نقاطك\n📮| تم زياده {* "..Total_Point.."* } من الرسائل \n📑| اصبحت رسائلك { *"..redis:get(ws..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n🔖"
end
end
...
redis:del(ws..':List_Rolet:'..msg.chat_id_) 
redis:del(ws..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
🤡¦•⊱ الالعاب لبوت []]..redis:get(ws..':NameBot:')..[[]  ، ! 🎖
...
if msg.text and not redis:get(ws..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(ws..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_alii:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  ⌯  احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(ws..':Set_Amthlh:'..msg.chat_id_) then -- // امثله
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  ⌯  احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(ws..':Set_Hzorh:'..msg.chat_id_) then -- // حزوره
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Hzorh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  ⌯  احسنت اجابتك صحيحه   \n*   \n')
end


if msg.text == redis:get(ws..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎊   احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text == redis:get(ws..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
...
if msg.text == redis:get(ws..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  ⌯  احسنت اجابتك صحيحه   \n*   \n')
end 
if msg.text == redis:get(ws..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*   🎉     احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text:match("^(%d+)$") and redis:get(ws..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
...
if msg.text:match('^(@[%a%d_]+)$') and redis:get(ws..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(ws..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*⌯* المعرف {['..msg.text..']} موجود اساسا' )
end
redis:sadd(ws..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(ws..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(ws..':List_Rolet:'..msg.chat_id_)
...
if redis:get(ws.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
...
if (msg.text == redis:get(ws.."GAME:CHER"..msg.chat_id_)) and redis:get(ws.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'⌯ اجابتك صحيحه ذكي وربي 😙')     
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws.."GAME:S"..msg.chat_id_)
redis:del(ws.."GAME:CHER"..msg.chat_id_)
...
if redis:get(ws.."GAME:S"..msg.chat_id_) then  
...
if redis:get(ws.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
