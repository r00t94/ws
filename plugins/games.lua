...
name = katu[math.random(#katu)]
redis:set(ws..':Set_ang:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_ria:'..msg.chat_id_,name)
...
return '⌯ اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
else
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_fkk:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_trkib:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_Arg:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(ws..':Set_twet:'..msg.chat_id_,name)
...
if msg.text == redis:get(ws..':Set_trkib:'..msg.chat_id_) then -- // تركيب
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_trkib:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت ركبتها صح   \n*   \n')
end
if msg.text == redis:get(ws..':Set_ang:'..msg.chat_id_) then -- // النجليزي
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_ang:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت جبتها صح كفو عليك ☺   \n*   \n')
end

if msg.text == redis:get(ws..':Set_ria:'..msg.chat_id_) then -- // رياضيات
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_ria:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت المسائله الصحيحه   \n*   \n')
end

if msg.text == redis:get(ws..':Set_fkk:'..msg.chat_id_) then -- // تفكيك
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_fkk:'..msg.chat_id_)
...
salemn = '['..(redis:get(ws.."chencher"..msg.sender_user_id_) or '')..']'
