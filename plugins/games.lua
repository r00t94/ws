...
return 'اول من يكتب هذا العدد يفوز ↤︎`'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ↤︎    `'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(ws.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(ws.."GAME:CHER"..msg.chat_id_,'نشيط') 
...
redis:set(ws.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
