...
redis:setex(ws..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_,500,true)
...
if msg.text and msg.type ~= "pv" and redis:get(ws..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_) then
redis:del(ws..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_)
