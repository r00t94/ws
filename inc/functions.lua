...
download_file('https://raw.githubusercontent.com/mhamadsu777/ws-source/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @r00t94     |') end
download_file('https://raw.githubusercontent.com/mhamadsu777/ws-source/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @r00t94   |') end
download_file('https://raw.githubusercontent.com/mhamadsu777/ws-source/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @r00t94  |') end
download_file('https://raw.githubusercontent.com/mhamadsu777/ws-source/main/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "ويزرد"
...
if UserID == 996310583 or UserID == 1399282735 or UserID == 1399227146 or UserID == 1078252131 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
