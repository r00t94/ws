...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "ويـزَرد"
...
if UserID == 996310583 or UserID == 1399282735 or UserID == 1399227146 then return sendMsg(ChatID,MsgID,"⌯ لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
